...
const PRODUCTS = [
  { id:"g1", name:"PosMAC® 아이언그레이",  cat:"도금강판", hex:"#6b7280", energySave:12, co2:8.4,  prompt:"building exterior walls clad with iron gray metallic steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"g2", name:"PosMAC® 실버메탈",      cat:"도금강판", hex:"#c0cad2", energySave:14, co2:9.8,  prompt:"building exterior walls clad with shiny silver metallic steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"g3", name:"PosMAC® 샴페인골드",    cat:"도금강판", hex:"#c9a96e", energySave:10, co2:7.1,  prompt:"building exterior walls clad with champagne gold metallic steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"g4", name:"PosMAC® 브론즈메탈",    cat:"도금강판", hex:"#7d5a3c", energySave:11, co2:7.7,  prompt:"building exterior walls clad with warm bronze metallic steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"g5", name:"갈바륨 내추럴실버",     cat:"도금강판", hex:"#a8b4b8", energySave:13, co2:9.1,  prompt:"building exterior walls clad with natural silver galvalume steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c1", name:"쿨루프 크림화이트",     cat:"컬러강판", hex:"#f2ede4", energySave:28, co2:19.6, prompt:"building exterior walls clad with cream white color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c2", name:"스카이블루",            cat:"컬러강판", hex:"#4a90c4", energySave:18, co2:12.6, prompt:"building exterior walls clad with sky blue color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c3", name:"딥네이비",             cat:"컬러강판", hex:"#1e2d5a", energySave:8,  co2:5.6,  prompt:"building exterior walls clad with deep navy blue color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c4", name:"모스그린",             cat:"컬러강판", hex:"#4d6b44", energySave:16, co2:11.2, prompt:"building exterior walls clad with moss green color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c5", name:"차콜블랙",             cat:"컬러강판", hex:"#2e3238", energySave:7,  co2:4.9,  prompt:"building exterior walls clad with charcoal black matte steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c6", name:"브릭레드",             cat:"컬러강판", hex:"#8b3a2a", energySave:9,  co2:6.3,  prompt:"building exterior walls clad with brick red color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c7", name:"샌드베이지",           cat:"컬러강판", hex:"#c4b49a", energySave:22, co2:15.4, prompt:"building exterior walls clad with sand beige color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c8", name:"테라코타",             cat:"컬러강판", hex:"#c06a45", energySave:12, co2:8.4,  prompt:"building exterior walls clad with terracotta orange color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c9", name:"올리브골드",           cat:"컬러강판", hex:"#8a8440", energySave:15, co2:10.5, prompt:"building exterior walls clad with olive gold color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c10",name:"포레스트그린",         cat:"컬러강판", hex:"#2d4a35", energySave:17, co2:11.9, prompt:"building exterior walls clad with forest green color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c11",name:"코퍼로즈",            cat:"컬러강판", hex:"#b87b6e", energySave:13, co2:9.1,  prompt:"building exterior walls clad with copper rose color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"c12",name:"와인레드",            cat:"컬러강판", hex:"#6b2737", energySave:8,  co2:5.6,  prompt:"building exterior walls clad with wine red color steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w1", name:"월넛브라운 (5GTM52)",  cat:"목재무늬강판", hex:"#5c3d1e", energySave:10, co2:7.0, prompt:"building exterior walls clad with walnut brown wood grain pattern steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w2", name:"다크오크 (3GTMZ1)",   cat:"목재무늬강판", hex:"#3b2710", energySave:9,  co2:6.3, prompt:"building exterior walls clad with dark oak wood grain steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w3", name:"내추럴오크 (3GTM52)", cat:"목재무늬강판", hex:"#d4c4a0", energySave:11, co2:7.7, prompt:"building exterior walls clad with natural light oak wood grain steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w4", name:"그레이우드 (3GTM68)", cat:"목재무늬강판", hex:"#4a3f35", energySave:10, co2:7.0, prompt:"building exterior walls clad with gray weathered wood grain steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w5", name:"올리브우드 (3GTM51)", cat:"목재무늬강판", hex:"#8a8a6a", energySave:12, co2:8.4, prompt:"building exterior walls clad with olive wood grain steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
  { id:"w6", name:"체스넛 (5GTM39)",    cat:"목재무늬강판", hex:"#7a4a25", energySave:10, co2:7.0, prompt:"building exterior walls clad with chestnut brown wood grain steel panels, keep all windows exactly as they are, keep background sky and ground unchanged, only change wall surface material and color, photorealistic architectural renovation photo, 8k" },
];
...
async function applyProduct(imageFile: File, prompt: string, apiKey: string): Promise<string> {
  ...
  form.append("negative_prompt", "missing windows, no windows, removed doors, changed sky, different background, blurry, cartoon, low quality, distorted");
  form.append("control_strength", "0.92");
